...
const API_BASE = 'https://task-manager-backend-qirs.onrender.com/api/tasks'
      ...
      <div className=' bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn'>
        ...
        <form onSubmit={handleSubmit} className=' space-y-4'>
          ...
          <div>
            ...
            <div className=' flex items-center border borer-purple-100 rounded-lg px-3 py-2.5
          ...
          <div>
            <label className=' flex items-center gap text-sm font-medium text-gray-700 mb-1'>
          ...
          <button type='submit' disabled={loading} className=' w-full bg-gradient-to-r from-fuchsia-500 
          to-purple-600 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center 
          gap-2 disabled:opacity-50 hover:shadow-md transition-all duration-200'>
